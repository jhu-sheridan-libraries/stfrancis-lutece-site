    ...
    $("#search_elements").on("keyup", function () {
		...
		if ( $("select#items_per_page").length > 0 ){
			...
			if( s1 < s2 && nb ==0 ) {
				...
				$(this).parent().after('<span class="alert alert-warning">Attention: You did not select all the lines  !! <button id="showall" class="btn btn-primary btn-xs">Show all</button></span>')
