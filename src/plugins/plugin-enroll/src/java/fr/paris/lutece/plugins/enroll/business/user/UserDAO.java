...
// import fr.paris.lutece.plugins.enroll.business.ProjectDAO;
...
public final class UserDAO implements IUserDAO
{
    ...
    private static final String SQL_QUERY_NEW_PK = "SELECT max(id_user) FROM enroll_user";
    private static final String SQL_QUERY_INSERT = "INSERT INTO enroll_user (id_user, guid, first_name, last_name, email, phone_number) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String SQL_QUERY_UPDATE = "UPDATE enroll_user SET guid = ?, first_name = ?, last_name = ?, email = ?, phone_number = ? WHERE id_user = ?";
    private static final String SQL_QUERY_DELETE = "DELETE FROM enroll_user WHERE id_user = ?";
    private static final String SQL_QUERY_SELECT_COLUMNS = "SELECT id_user, guid, first_name, last_name, email, phone_number FROM enroll_user";
    ...
    {
        user.setIdUser( newPrimaryKey( plugin ) );
