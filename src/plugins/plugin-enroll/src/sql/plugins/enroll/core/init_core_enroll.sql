...
('ENROLL_MANAGEMENT','enroll.adminFeature.ManageEnroll.name',1,'jsp/admin/plugins/enroll/ManageProjects.jsp','enroll.adminFeature.ManageEnroll.description',0,'enroll',NULL,NULL,NULL,4);
